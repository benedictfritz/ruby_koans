...
class AboutSymbols < EdgeCase::Koan
  ...
  # => If the include statement checked whether the symbols included the symbol
  # that we're checking for, checking for it would have created it so it'd be 
  # there.
  ...
  # This isn't fully correct. Checking if the symbols include a symbol,
  # having that symbol be part of the check creates it. So this will always
  # evaluate to true.
  ...
  # => They are immutable and stay in memory forever. Fast for hashing, but
  # can cause bloat.
end
